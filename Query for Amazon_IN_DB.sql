...
-- Q1. Find Top 5 states by total orders where each state sale is greater than average orders accross orders.
-- state, 
...
-- Q2. Find the details of the top 5 products with the highest total sales, where the total sale for each product is greater than the average sale across all products.
...
-- Q1. List all orders along with the product details (product name, price) and seller details (seller name) for each order.
...
-- Q2. Find the total sales amount for each category.
...
-- Q3. List all customers who have made returns along with the number of returns made by each customer.
...
-- Q4. Find the average price of products sold by each seller.
...
-- Q5. Identify the top 3 sellers based on the total sales amount.
...
-- Q6. List all orders where the quantity sold is greater than the average quantity sold across all orders.
...
-- Q7. Find the total sales amount for each category in each state.
...
-- Q8. List the products that have not been sold yet.
...
-- Q9. Find the total sales amount for each seller, excluding the sales amount for orders with returns.
...
-- Q10. Identify the customers who have made orders in more than one state.
...
-- Q1. Classify orders by quantity: 
...
-- Q2. Categorize products by price range:
...
-- Q3. Identify returning customers: 
...
-- Q4. Determine seller performance: 
...
-- Q3. Identifying Customer Loyalty: 
