...
-- Q2. Find top 3 products and revenue generated having revenue > 30000
...
-- Q3. Which is the best selling month in 2022 based on revenue?
-- Group by month
-- Where year = 2022
...
-- Q4. How many orders were placed by each customer,
...
-- Q5. Which category has the highest average sale amount per order?
...
-- Q6. Identify the top 3 best-selling products(sub-categories)
...
-- Q1. Identify all orders that have been returned, along with the
-- details of the returns (if available). (LEFT JOIN)
...
-- Q2. Find customers name and total orders and total revenue
...
-- Q3. Find all instances where products have been sold, returned, or both,
-- along with the associated details.
